...
const Navbar = ({ closehidden, setCloseHidden, setshowblock, moveingblock, mintbtnshow, setBtnShow, address, wallet, balance, afterSuccess, setAfterSuccess, onConnectClick, playBtn, setPlaybtn, setvideoStart2, videoStart2, videoStart, Allbgshow, setAllbgshow }) => {
